  ...
  return (
    ...
    >
      ...
      <div className="relative w-full mx-auto z-10">
        ...
        <div className="relative h-[700px] flex items-end justify-center">
          ...
          >
            ...
            <div className="relative animate-float">
              <div className="flex items-end justify-center relative pb-24">
                <img 
        ...
        <div className="flex justify-center absolute bottom-16 left-1/2 transform -translate-x-1/2 z-30 space-x-3">
